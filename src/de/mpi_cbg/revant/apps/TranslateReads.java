...
public class TranslateReads {
	...
	public static void main(String[] args) throws IOException {
		...
		final boolean IS_LAST_CHUNK = Integer.parseInt(args[15])==1;
		...
		RepeatAlphabet.translateReads(ALIGNMENTS_FILE,LAST_TRANSLATED_READ,MAX_ERROR,IO.quantum,IS_LAST_CHUNK,TRANSLATED_FILE_CHARACTERS,TRANSLATED_FILE_BOUNDARIES,TRANSLATED_FILE_HISTOGRAM,FULLY_UNIQUE_READS,FULLY_CONTAINED_READS);
	}
