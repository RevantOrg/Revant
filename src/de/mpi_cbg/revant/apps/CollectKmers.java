...
public class CollectKmers {
	...
	public static void main(String[] args) throws IOException {
		...
		while (str1!=null) {
			...
			RepeatAlphabet.getKmers(str1,K,kmers,null,avoidedIntervals,lastAvoidedInterval,-1,readLength,RepeatAlphabet.boundaries,-1/*argument not used*/,-1/*argument not used*/,tmpKmer,tmpArray2,tmpArray3,tmpMap,tmpChar);
			str1=br1.readLine(); str2=INTERVALS_FILE_EXISTS?br2.readLine():null; 
