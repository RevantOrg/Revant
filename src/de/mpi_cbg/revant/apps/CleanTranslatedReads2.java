...
public class CleanTranslatedReads2 {
	...
	public static void main(String[] args) throws IOException {
		...
		final String NEW_ALPHABET_FILE = args[6];
		final String OLD2NEW_FILE = args[7];  // Map oldNonUnique -> newNonUnique
		
		RepeatAlphabet.deserializeAlphabet(ALPHABET_FILE,2);
		RepeatAlphabet.loadAlphabetCount(ALPHABET_COUNTS_FILE,RepeatAlphabet.lastAlphabet+1);
		int[] old2new = RepeatAlphabet.cleanTranslatedRead_updateAlphabet(N_NEW_CHARACTERS,NEW_CHARACTERS_FILE,MIN_FREQUENCY);
