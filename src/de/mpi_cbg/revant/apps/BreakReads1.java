...
public class BreakReads1 {
	...
	public static void main(String[] args) throws IOException {
		...
		final int nReads_new = Reads.breakReads(null,N_READS,READ_LENGTHS_FILE,0,QUALITIES_FILE,QUALITY_THRESHOLDS_FILE,MIN_LOW_QUALITY_LENGTH,OLD2NEW_FILE,NEW2OLD_FILE,READ_LENGTHS_FILE_NEW,null);		
