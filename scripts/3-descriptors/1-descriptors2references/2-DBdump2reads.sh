...
# $DBdump -s$, naming the files with the read ID provided in an input list. The script
# assumes that the output of DBdump is in file $DBdump-output.txt$ in the step5 directory.
#
# --------------------------------- CONFIGURATION ----------------------------------------
